...
namespace BabyStore.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] SelectdRoles)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    DateEditUser = userViewModel.DateEditUser,
                ...
                {
                    if (SelectdRoles != null)
                    {
                        var result = await UserManager.AddToRolesAsync(user.Id, SelectdRoles);
        ...
        public async Task<ActionResult> Edit(EditUserViewModel editUser, params string[] selectedRole)
        {
            ...
            { 
                ...
                user.StatusUser = editUser.StatusUser;
                user.DateEditUser = DateTime.Now;
